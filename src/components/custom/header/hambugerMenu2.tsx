        ...
        <Sheet open={open} onOpenChange={setOpen}>
            ...
            <SheetContent
                ...
                {isMobile ? (
                    <>
                        <SheetHeader>
                            <SheetTitle className='text-3xl text-primary font-extrabold text-left border-b-white border-b-[1px] pb-2'>NGUYÊN THỐNG JP</SheetTitle>
                        </SheetHeader>

          ...
          <div ref={carouselRef} className="relative">
            ...
            >
              ...
              <div className="flex justify-center mb-8">
                <div className="flex space-x-1">
                  {[...Array(currentTestimonial.rating)].map((_, i) => (
                    <Star key={i} className="h-5 w-5 fill-[#d5b78f] text-[#d5b78f]" />
                  ))}
                </div>
              </div>
              ...
              <div className="text-center">
                <p className="font-medium text-xl text-neutral-800 mb-1">{currentTestimonial.name}</p>
              ...
              <div className="flex justify-center mt-10 space-x-1">
                {testimonials.map((_, index) => (
                  <div
                    key={index}
                    className={`h-1 rounded-full transition-all duration-300 ${index === currentIndex ? "w-8 bg-[#d5b78f]" : "w-2 bg-gray-300"
                      }`}
                  ></div>
                ))}
              </div>
